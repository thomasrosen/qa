  ...
  return (
    <section>
      ...
      <P>
        ...
        outlines how I collect, use, and share your data. By using the website at qa.thomasrosen.me,
      ...
      <P>
        ...
        published. To ensure privacy and keep storage volume low, all information is post-processed,
        to remove potential privacy concerns and then exported as a dataset. The dataset will be
        available for download in the insights section of the website
      </P>
      <Headline type="h3">Data Anonymisation</Headline>
      <P>
        To enhance your privacy, your answers are grouped under an anonymous identifier. This helps
        to keep the storage volume manageable on Qrowdsourced Answers.
      </P>
      <P>
        You can generate a new anonymous identifier on the “About You“ page. Here, you can also view
        the data associated with your identifier.
      </P>
      <Headline type="h3">Account Information</Headline>
      <P>
        Please note that Qrowdsourced Answers does not require user accounts. While this means your
        data cannot be easily traced back to you, it also means that once your data is published in
        the dataset, it cannot be deleted.
      </P>
